...
public class GetChamberListAction extends ActionSupport implements Preparable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -955998451779089940L;
	/**
	 * 
	 */

//	Chamber List
	List<Chamber> listChamber = new ArrayList<>();
